Shader "Unlit/SkyboxShader"
{
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			half calculateSpot(half3 sunDirPos, half3 skyDirPos, half size, out half distance)
			{
			...
			half4 frag(v2f IN) : SV_Target
			{
				...
				half sunDist;
				half moonDist;
				half3 sunMie = calculateSpot(_WorldSpaceLightPos0.xyz, IN.texcoord.xyz, _SunSize, sunDist);
				half3 moonMie = calculateSpot(_MoonPosition.xyz, IN.texcoord.xyz, _MoonSize, moonDist);
